...
function createStyles(C: any) {
  return StyleSheet.create({
    ...
    compactCopy: { flex: 1 },
    compactKicker: { fontFamily: 'Outfit_600SemiBold', fontSize: 9, letterSpacing: 1.8, color: 'rgba(255,255,255,0.68)', textTransform: 'uppercase' },
    compactTitle: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 22, color: '#FFFFFF', marginTop: 2 },
    ...
    compactCode: { fontFamily: 'Outfit_600SemiBold', fontSize: 13, letterSpacing: 1.5, color: '#FFFFFF' },
    copyBlock: { marginBottom: 14 },
    kicker: { fontFamily: 'Outfit_600SemiBold', fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: C.GOLD_DEEP },
    title: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 28, lineHeight: 32, color: C.INK, marginTop: 4 },
    desc: { fontFamily: 'Outfit_300Light', fontSize: 12, lineHeight: 18, color: C.MUTED, marginTop: 4 },
    ...
    rewardLabel: { fontFamily: 'Outfit_600SemiBold', fontSize: 10, letterSpacing: 2, color: 'rgba(255,255,255,0.72)', textTransform: 'uppercase' },
    code: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 42, letterSpacing: 3, color: '#FFFFFF', marginTop: 4 },
    expiry: { fontFamily: 'Outfit_300Light', fontSize: 11, color: 'rgba(255,255,255,0.78)', marginTop: 6 },
    scratchLayer: { ...StyleSheet.absoluteFillObject, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
    shine: { position: 'absolute', width: 74, height: 260, backgroundColor: 'rgba(255,255,255,0.36)' },
    scratchGlyph: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 24, color: C.BURGUNDY, marginBottom: 6 },
    scratchText: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 25, color: C.NAVY_DEEP },
    scratchHint: { fontFamily: 'Outfit_300Light', fontSize: 10, color: C.MUTED, letterSpacing: 1.7, textTransform: 'uppercase', marginTop: 4 },
    ...
    revealBtnText: { fontFamily: 'Outfit_600SemiBold', color: C.BURGUNDY, fontSize: 11, letterSpacing: 1.2, textTransform: 'uppercase' },
  });
}
