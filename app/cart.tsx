...
import { CartItem, CartItemRow } from "../components/cart/CartItemRow";
...
export default function CartScreen() {
  ...
  const [validatedCampaign, setValidatedCampaign] = useState<{
    name: string;
    offerCode: string;
  } | null>(null);
  ...
  const handleWhatsAppInquiry = async () => {
    ...
    try {
      const response = await fetch(
        "https://apis.27012610.xyz/inquiries/create",
        {
          method: "POST",
              ...
              ListFooterComponent={
                <View style={styles.footer}>
                  ...
                  {items.length > 0 && (
                    ...
                    >
                      <Text style={styles.clearCartBtnText}>Clear Order</Text>
                    </TouchableOpacity>
                  )}
                </View>
              }
